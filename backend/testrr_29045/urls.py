"""testrr_29045 URL Configuration
...
admin.site.site_header = "testrr"
admin.site.site_title = "testrr Admin Portal"
admin.site.index_title = "testrr Admin"

# swagger
api_info = openapi.Info(
    title="testrr API",
    default_version="v1",
    description="API documentation for testrr App",
)
